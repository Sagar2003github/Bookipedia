...
import Logo from "../../../../uploads/BOOKlogo.png"; // Import your logo
  ...
  return (
    <div>
      <section className="flex flex-wrap items-center justify-between">
        {/* Left side form */}
        <div className="w-full lg:w-1/2 p-10 ml-auto lg:ml-16">
        ...
        {/* Right side image */}
        <div className="hidden lg:block w-100% lg:w-1/3 pr-14">
          <img
