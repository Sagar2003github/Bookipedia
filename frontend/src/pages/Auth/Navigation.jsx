    ...
    >
      <div className="flex flex-col justify-center space-y-4">
        ...
        <button
          ...
          className="flex items-center transition-transform transform hover:translate-x-2 mt-[3rem] pt-8"
        >
          {isFullscreen ? (
            <AiOutlineFullscreenExit size={26} />
          ) : (
            <AiOutlineFullscreen size={26} />
          )}
          <span className="hidden nav-item-name mt-[3rem]">{isFullscreen ? "Exit Fullscreen" : "Fullscreen"}</span>
        </button>
